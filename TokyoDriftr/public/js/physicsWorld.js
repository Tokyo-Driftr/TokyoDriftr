...
export function carPhysicsTick(car) {
    ...
    if (car.controller.brake) {
        ...
        if (car.controller.accelerate && Math.sqrt(body.body.linearVelocity.x*body.body.linearVelocity.x+body.body.linearVelocity.z*body.body.linearVelocity.z) < car.options.max_speed) {
